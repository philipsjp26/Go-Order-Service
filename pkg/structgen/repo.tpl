...
// {{.ObjectName}}er contract of {{.ObjectName}}
type {{.ObjectName}}er interface {
    Storer
	Updater
	Deleter
	Counter
	FindOne(ctx context.Context, param interface{}) (*entity.{{.ObjectName}}, error)
	Find(ctx context.Context, param interface{}) ([]entity.{{.ObjectName}}, error)
	FindWithCount(ctx context.Context, param interface{}) ([]entity.{{.ObjectName}}, int64, error)
}
...
func New{{.ObjectName}}(db databasex.Adapter) {{.ObjectName}}er {
	return &{{.StructName}}{db: db}
}

// FindOne {{.StructName}}
func (r *{{.StructName}}) FindOne(ctx context.Context, param interface{}) (*entity.{{.ObjectName}}, error) {
	var (
...
// Find {{.StructName}}
func (r *{{.StructName}}) Find(ctx context.Context, param interface{}) ([]entity.{{.ObjectName}}, error) {
	var (
		result []entity.{{.ObjectName}}
		err    error
	)
...
// Count {{.StructName}}
func (r *{{.StructName}}) Count(ctx context.Context, p interface{}) (total int64, err error) {
...
func (r *{{.StructName}}) FindWithCount(ctx context.Context, param interface{}) ([]entity.{{.ObjectName}}, int64, error) {
